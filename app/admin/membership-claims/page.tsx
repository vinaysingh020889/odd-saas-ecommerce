...
export default async function MembershipClaimsPage({ searchParams }: PageProps) {
  ...
  return <div className="grid gap-6"><PageHeader eyebrow="Membership Operations" title="Membership Claims Queue" description="Track complimentary Kundli, shop, Puja, service, and Asthi claims from reservation through payment, fulfilment, cancellation, and exceptions." tone="admin" />
